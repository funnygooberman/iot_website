...
<body class="body-3">
  ...
  <div class="w-form">
    <form action="admin_register.php" id="wf-form-Login-Form" name="wf-form-Login-Form" redirect="admin_login.php" data-redirect="admin_login.php" method="post" class="form form-2 form-3">
